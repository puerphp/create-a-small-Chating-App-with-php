            ...
            <div class="login-card-form">
                ...
                <form>
                    <div class="form-group">
                        <input class="form-control" type="text"  name="email" id="email" placeholder="privet ID">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <button class="btn btn-main btn-lg w-100" id="sendinfo" type="submit">Login</button>
                    </div>
                </form>
                <div class="text-left my-4">
                   
                    <div>don't have account? <a href="register.php" class="fw-bold text-primary">Create One</a>
                    </div>
                </div>
            </div>
        </div>
